    ...
    <main class="main">
        <div class="topbar">
            <div>
                ...
                <p>Lihat progress, nilai kuis, dan hasil latihan coding web yang sudah kamu kerjakan.</p>
            </div>
        </div>
        ...
        <div class="card" style="margin-top:18px;">
            <h3>Riwayat Latihan Coding</h3>
            <p>Kode yang kamu simpan melalui fitur Live Coding akan tampil di sini.</p>
            <br>
